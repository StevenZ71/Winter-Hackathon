...
export default function BattleCard(props: any){
    ...
    return(
        <>
            ...
            style={{transform: hover&&!back ? `translate(42.5vw,20vh) scale(2) rotate(0deg)` : `translate(${props.index*10 + 35}vw,60vh) rotate(${props.index*3}deg)`, zIndex: hover&&!back ? '1': '0', animationFillMode: 'forwards', animationName: running ? 'hoverBattleCard' : '', animationDuration: '1s', animationDirection: hover ? 'forwards' : 'reverse'}}
            >
                {props.card.topic}
            </div>
        </>
